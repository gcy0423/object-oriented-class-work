...
export const routeTable = {
  ...
  reports: { label: "Reports", roles: ["student", "teacher", "admin"] },
  "identity-admin": { label: "Identity", roles: ["teacher", "admin"] },
  operations: { label: "Operations", roles: ["teacher", "admin"] },
...
export function subtitleFor(route, user) {
  return {
    ...
    reports: "Generate structured teaching reports and export Markdown, HTML, or CSV evidence.",
    "identity-admin": "Manage users, classrooms, course enrollment, study groups, and role permission evidence.",
    operations: "Run import previews, batch jobs, audit trail reviews, and deep portfolio analysis.",
